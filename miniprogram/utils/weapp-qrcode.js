...
t = function() {
    var t = Object.prototype.hasOwnProperty, r = Object.prototype.toString, o = Object.defineProperty, n = Object.getOwnPropertyDescriptor, i = function(t) {
        return "function" == typeof Array.isArray ? Array.isArray(t) : "[object Array]" === r.call(t);
    }, a = function(e) {
        if (!e || "[object Object]" !== r.call(e)) return !1;
        var o, n = t.call(e, "constructor"), i = e.constructor && e.constructor.prototype && t.call(e.constructor.prototype, "isPrototypeOf");
    ...
    h.prototype = {
        ...
        for (var r = 0, o = 0, n = 0, i = new Array(e.length), a = new Array(e.length), u = 0; u < e.length; u++) {
            var s = e[u].dataCount, h = e[u].totalCount - s;
            o = Math.max(o, s), n = Math.max(n, h), i[u] = new Array(s);
            for (var l = 0; l < i[u].length; l++) i[u][l] = 255 & t.buffer[l + r];
            r += s;
            var f = A.getErrorCorrectPolynomial(h), g = new M(i[u], f.getLength() - 1).mod(f);
        ...
        var m = new Array(d), p = 0;
        for (l = 0; l < o; l++) for (u = 0; u < e.length; u++) l < i[u].length && (m[p++] = i[u][l]);
        for (l = 0; l < n; l++) for (u = 0; u < e.length; u++) l < a[u].length && (m[p++] = a[u][l]);
        return m;
    };
    for (var f = {
        MODE_NUMBER: 1,
    ...
    P.getRSBlocks = function(t, e) {
        ...
        for (var o = r.length / 3, n = new Array(), i = 0; i < o; i++) for (var a = r[3 * i + 0], u = r[3 * i + 1], s = r[3 * i + 2], h = 0; h < a; h++) n.push(new P(u, s));
        return n;
        ...
        (t = function t() {
            var r, o, n, h, l, f, g = arguments[0], c = 1, d = arguments.length, m = !1;
            for ("boolean" == typeof g && (m = g, g = arguments[1] || {}, c = 2), (null == g || "object" !== e(g) && "function" != typeof g) && (g = {}); c < d; ++c) if (null != (r = arguments[c])) for (o in r) n = s(g, o), 
            g !== (h = s(r, o)) && (m && h && (a(h) || (l = i(h))) ? (l ? (l = !1, f = n && i(n) ? n : []) : f = n && a(n) ? n : {}, 
            u(g, {
                name: o,
                newValue: t(m, f, h)
            })) : void 0 !== h && u(g, {
            ...
            for (var o = t.width / r.getModuleCount(), n = t.height / r.getModuleCount(), i = 0; i < r.getModuleCount(); i++) for (var a = 0; a < r.getModuleCount(); a++) {
                ...
                e.setFillStyle(u);
                var s = Math.ceil((a + 1) * o) - Math.floor(a * o), h = Math.ceil((i + 1) * o) - Math.floor(i * o);
